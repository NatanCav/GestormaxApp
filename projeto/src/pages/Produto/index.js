...
// Seus estilos (mantidos como estavam, pois parecem corretos)
const styles = StyleSheet.create({
    ...
    header: {
        ...
        alignItems: 'center',
        padding: 20,
        paddingTop: 40, // Ajuste para status bar (pode precisar variar)
    },
    headerTitle: {
        fontSize: 22,
        fontWeight: 'bold',
    ...
    produtosContainer: {
        flex: 1,
        marginBottom: 20, // Ajustado para não colar no botão add
    },
    produtoCard: {
        flexDirection: 'row',
        justifyContent: 'space-between',
    ...
    produtoInfo: {
        flex: 1,
        marginRight: 10, // Adiciona espaço
    },
    produtoNome: {
        fontSize: 16,
        fontWeight: '600',
    ...
    addButton: {
        position: 'absolute',
        right: 20,
        bottom: 30, // Ajustado para não ficar tão embaixo
